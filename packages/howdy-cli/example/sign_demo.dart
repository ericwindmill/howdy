...
void main() {
  ...
  Sign(
    content: [
      ...
      StyledText(''),
      StyledText('Something important happened that you should know about.'),
    ],
    padding: const EdgeInsets.symmetric(horizontal: 1, vertical: 1),
    margin: const EdgeInsets.only(left: 2),
    width: 40,
  ...
  Sign(
    content: [
      StyledText('Note', style: TextStyle(bold: true)),
      StyledText(''),
      StyledText(
  ...
  Sign(
    content: [
      StyledText('Full width sign', style: TextStyle(bold: true)),
      StyledText(''),
      StyledText(
